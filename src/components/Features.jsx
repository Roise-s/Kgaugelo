...
export const BentoCard = ({ src, title, description, isComingSoon, site }) => {
          ...
          >
            {/* Radial gradient hover effect */}
                ...
                <a href={site} target="_blank">
                  <TiLocationArrow className="relative z-20" />
                  <p className="relative z-20">View Site</p>
                </a>
    ...
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">
          Feel free to reach out through my contact information below. Your feedback, questions and interveiws are most important to me as I strive to provide exceptional service
        </p>
      </div>
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
          <BentoCard
            ...
            isComingSoon={false}
            site='https://roise-s.github.io/edu/'
          />
        </BentoTilt>
